...
public class HelloWorld extends PApplet {
	...
	public void setup() {
		...
		// Create map1
		map1 = new UnfoldingMap(this, 50, 50, 250, 500, provider);
		map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f)); // The next line zooms in and centers the map at 32.9 (latitude) and -117.2 (longitude)
		MapUtils.createDefaultEventDispatcher(this, map1); // This line makes the map interactive
		
		// Create map2 
		map2 = new UnfoldingMap(this, 350, 50, 250, 500, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(32.7f, -96.8f));
