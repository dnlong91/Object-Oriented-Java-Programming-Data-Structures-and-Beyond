...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
	    ...
	    printQuakes();
	    System.out.println("\n");
	    System.out.println("Output using file test2.atom with sortAndPrint(5)\n");
	    sortAndPrint(5);
	    System.out.println("\n");
	    System.out.println("Output using file test2.atom with sortAndPrint(20)\n");
	    sortAndPrint(20);
	    System.out.println("\n");
	...
	private void sortAndPrint(int numToPrint) {
		// Sort all earthquakes in reverse order
		ArrayList<EarthquakeMarker> earthquakeList = new ArrayList<EarthquakeMarker>();
		for (Marker m : quakeMarkers) {
			EarthquakeMarker em = (EarthquakeMarker)m;
			earthquakeList.add((em));
		}
		Collections.sort(earthquakeList, Collections.reverseOrder());
		// Print only the top numToPrint earthquakes from the sorted list
		for (int i = 0; i < numToPrint; i++) {
			double magnitude = earthquakeList.get(i).getMagnitude();
			String title = earthquakeList.get(i).getTitle();
			System.out.println("M " + magnitude + " - " + title);
		}
	}
