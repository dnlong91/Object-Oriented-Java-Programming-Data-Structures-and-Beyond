...
public abstract class DocumentCountSyllablesSol {
	 ...
	 */
	protected DocumentCountSyllablesSol(String text) {
		this.text = text;
	}
	 ...
	 */
	public static boolean testCase(DocumentCountSyllablesSol doc, int syllables, int words, int sentences) {
