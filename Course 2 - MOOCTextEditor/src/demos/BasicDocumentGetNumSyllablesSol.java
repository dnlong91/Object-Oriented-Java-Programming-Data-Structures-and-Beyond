 ...
 * 
 */
public class BasicDocumentGetNumSyllablesSol extends DocumentCountSyllablesSol {
	/** Create a new BasicDocument object
	 * 
	 * @param text The full text of the Document.
	 */
	public BasicDocumentGetNumSyllablesSol(String text) {
		super(text);
	}
...
//		System.out.println("\n" + sentences.size());
	...
	public static void main(String[] args) {
		 ...
		 */
		testCase(new BasicDocumentGetNumSyllablesSol("This is a test.  How many???  "
		        + "Senteeeeeeeeeences are here... there should be 5!  Right?"),
				16, 13, 5);
		testCase(new BasicDocumentGetNumSyllablesSol(""), 0, 0, 0);
		testCase(new BasicDocumentGetNumSyllablesSol("sentence, with, lots, of, commas.!  "
		        + "(And some poaren)).  The output is: 7.5."), 15, 11, 4);
		testCase(new BasicDocumentGetNumSyllablesSol("many???  Senteeeeeeeeeences are"), 6, 3, 2);
		testCase(new BasicDocumentGetNumSyllablesSol("Here is a series of test sentences. Your program should "
				+ "find 3 sentences, 33 words, and 49 syllables. Not every word will have "
				+ "the correct amount of syllables (example, for example), "
				+ "but most of them will."), 49, 33, 3);
		testCase(new BasicDocumentGetNumSyllablesSol("Segue"), 2, 1, 1);
		testCase(new BasicDocumentGetNumSyllablesSol("Sentence"), 2, 1, 1);
		testCase(new BasicDocumentGetNumSyllablesSol("Sentences?!"), 3, 1, 1);
		testCase(new BasicDocumentGetNumSyllablesSol("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad."),
		         32, 15, 1);
	}
}